    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-3 shadow-md rounded-md border border-gray-200">
          ...
          <p className="text-orange-600">Actual: {formatCurrency(actualValue)}</p>
          <p className={`border-t border-gray-200 mt-2 pt-2 ${isOverBudget ? 'text-red-600' : 'text-green-600'}`}>
